...
export default defineConfig({
  test: {
    ...
    coverage: {
      ...
      //
      // v2.0 baseline (post-9-commit stack): 84.97% statements, 79.42%
      // branches, 85.31% functions, 86.97% lines. Master pre-v2.0 baseline
      // was 76.38% statements — v2.0 is a +8.6-point improvement.
      thresholds: {
        statements: 85,
        branches: 78,
        functions: 84,
